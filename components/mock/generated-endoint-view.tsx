  ...
  return (
    <div className="space-y-8 animate-in zoom-in-95 fade-in duration-500">
      <div className="flex items-center justify-between">
        ...
        <Badge
          variant="outline"
          className="text-xs font-normal border-border bg-background"
        >
          SSL Secured
        </Badge>
      </div>
      ...
      <div className="group relative flex items-center gap-2 rounded-xl border border-border bg-card p-1.5 pl-4 shadow-sm transition-all hover:border-border/80">
        ...
        <div className="flex items-center gap-1">
          ...
          <Button
            onClick={copy}
            className={`h-8 px-4 rounded-lg text-xs font-medium uppercase tracking-widest transition-all duration-300 ${
              copied
      ...
      <div className="rounded-lg bg-primary p-4 text-xs font-mono text-primary-foreground/60 leading-relaxed shadow-2xl">
        ...
        <span className="text-primary-foreground">{url}</span>
      </div>
    </div>
  );
}
